...
countries_id SERIAL,
countries_name varchar(64) NOT NULL DEFAULT '' PRIMARY KEY,
...
UPDATE countries SET countries_name = 'USA' where countries_id = 223;
UPDATE countries SET countries_name = 'UK' where countries_id = 222;
